...
-   More can be found on [Wiki](https://en.wikipedia.org/wiki/Conjugate_prior#Table_of_conjugate_distributions)
...
[^2]: [Our World in Data](https://ourworldindata.org/gender-ratio#sex-ratio-at-birth)
...
-   A Bayesian approach would take the data into account only through
    this likelihood.
-   Homework: Show that under the uniform prior, the posteriors under
