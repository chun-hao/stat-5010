...
-    There are 18 subjects and 10 measurements per subject (day 0 is normal sleep; day 1~9 is reduced sleep).
...
-   Note a hierarchical model need not be a Bayesian model. However, Bayesian approach is the easiest and most natural way to fit a hierarchical model.
